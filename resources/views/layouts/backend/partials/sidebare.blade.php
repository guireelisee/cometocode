							...
							<div class="modal-body">
								<form action="{{ route('societe.store') }}" method="post">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" placeholder="Email de l'entreprise" name="email">
									</div>
									<div class="form-group">
						...
						<div class="bg-primary card-border"></div>
							<div class="card-body">
								<div class="media align-items-center">
									...
									<svg class="primary-icon" width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="../../www.w3.org/2000/svg.html">
						...
						<div class="card card-bd">
							...
							<div class="card-body">
								<div class="media align-items-center">
									...
									<svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="../../www.w3.org/2000/svg.html">
						...
						<div class="card">
							<div class="card-header d-block border-0 pb-0">
								...
								<div class="d-flex align-items-center">
									...
									<div>
										<svg class="mr-2" width="27" height="14" viewBox="0 0 27 14" fill="none" xmlns="../../www.w3.org/2000/svg.html">
							...
							<div class="col-sm-6">
								<div class="card">
									<div class="card-header border-0">
										...
										<div class="d-flex align-items-center">
											<svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="../../www.w3.org/2000/svg.html">
